...
namespace home_page.ServiceReference11 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference11.WebService1Soap")]
    public interface WebService1Soap {
        ...
        home_page.ServiceReference11.abcResponse abc(home_page.ServiceReference11.abcRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/abc", ReplyAction="*")]
        System.Threading.Tasks.Task<home_page.ServiceReference11.abcResponse> abcAsync(home_page.ServiceReference11.abcRequest request);
    }
    ...
    public partial class abcRequest {
        ...
        public home_page.ServiceReference11.abcRequestBody Body;
        
        public abcRequest() {
        }
        
        public abcRequest(home_page.ServiceReference11.abcRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class abcResponse {
        ...
        public home_page.ServiceReference11.abcResponseBody Body;
        
        public abcResponse() {
        }
        
        public abcResponse(home_page.ServiceReference11.abcResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WebService1SoapChannel : home_page.ServiceReference11.WebService1Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WebService1SoapClient : System.ServiceModel.ClientBase<home_page.ServiceReference11.WebService1Soap>, home_page.ServiceReference11.WebService1Soap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        home_page.ServiceReference11.abcResponse home_page.ServiceReference11.WebService1Soap.abc(home_page.ServiceReference11.abcRequest request) {
            return base.Channel.abc(request);
        }
        
        public string abc(string inputText) {
            home_page.ServiceReference11.abcRequest inValue = new home_page.ServiceReference11.abcRequest();
            inValue.Body = new home_page.ServiceReference11.abcRequestBody();
            inValue.Body.inputText = inputText;
            home_page.ServiceReference11.abcResponse retVal = ((home_page.ServiceReference11.WebService1Soap)(this)).abc(inValue);
            return retVal.Body.abcResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<home_page.ServiceReference11.abcResponse> home_page.ServiceReference11.WebService1Soap.abcAsync(home_page.ServiceReference11.abcRequest request) {
            return base.Channel.abcAsync(request);
        }
        
        public System.Threading.Tasks.Task<home_page.ServiceReference11.abcResponse> abcAsync(string inputText) {
            home_page.ServiceReference11.abcRequest inValue = new home_page.ServiceReference11.abcRequest();
            inValue.Body = new home_page.ServiceReference11.abcRequestBody();
            inValue.Body.inputText = inputText;
            return ((home_page.ServiceReference11.WebService1Soap)(this)).abcAsync(inValue);
        }
    }
}
