...
namespace ShapeDrawingTool.ServiceReference1 {
    ...
    public interface WebService1Soap {
        ...
        ShapeDrawingTool.ServiceReference1.abcResponse abc(ShapeDrawingTool.ServiceReference1.abcRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/abc", ReplyAction="*")]
        System.Threading.Tasks.Task<ShapeDrawingTool.ServiceReference1.abcResponse> abcAsync(ShapeDrawingTool.ServiceReference1.abcRequest request);
    }
    ...
    public partial class abcRequest {
        ...
        public ShapeDrawingTool.ServiceReference1.abcRequestBody Body;
        
        public abcRequest() {
        }
        
        public abcRequest(ShapeDrawingTool.ServiceReference1.abcRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class abcResponse {
        ...
        public ShapeDrawingTool.ServiceReference1.abcResponseBody Body;
        
        public abcResponse() {
        }
        
        public abcResponse(ShapeDrawingTool.ServiceReference1.abcResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WebService1SoapChannel : ShapeDrawingTool.ServiceReference1.WebService1Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WebService1SoapClient : System.ServiceModel.ClientBase<ShapeDrawingTool.ServiceReference1.WebService1Soap>, ShapeDrawingTool.ServiceReference1.WebService1Soap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ShapeDrawingTool.ServiceReference1.abcResponse ShapeDrawingTool.ServiceReference1.WebService1Soap.abc(ShapeDrawingTool.ServiceReference1.abcRequest request) {
            return base.Channel.abc(request);
        }
        
        public string abc(string inputText) {
            ShapeDrawingTool.ServiceReference1.abcRequest inValue = new ShapeDrawingTool.ServiceReference1.abcRequest();
            inValue.Body = new ShapeDrawingTool.ServiceReference1.abcRequestBody();
            inValue.Body.inputText = inputText;
            ShapeDrawingTool.ServiceReference1.abcResponse retVal = ((ShapeDrawingTool.ServiceReference1.WebService1Soap)(this)).abc(inValue);
            return retVal.Body.abcResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ShapeDrawingTool.ServiceReference1.abcResponse> ShapeDrawingTool.ServiceReference1.WebService1Soap.abcAsync(ShapeDrawingTool.ServiceReference1.abcRequest request) {
            return base.Channel.abcAsync(request);
        }
        
        public System.Threading.Tasks.Task<ShapeDrawingTool.ServiceReference1.abcResponse> abcAsync(string inputText) {
            ShapeDrawingTool.ServiceReference1.abcRequest inValue = new ShapeDrawingTool.ServiceReference1.abcRequest();
            inValue.Body = new ShapeDrawingTool.ServiceReference1.abcRequestBody();
            inValue.Body.inputText = inputText;
            return ((ShapeDrawingTool.ServiceReference1.WebService1Soap)(this)).abcAsync(inValue);
        }
    }
}
